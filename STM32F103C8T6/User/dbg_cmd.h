...
//#define DBG_CMD_PRN my_print_format
#define DBG_CMD_PRN printf
...
#define PARAM_2BYTE_NUM        5  // "2" 2byte
#define PARAM_4BYTE_NUM        2  // "4" 4byte   0:disable build
#define PARAM_FOLAT_NUM        2  // "f" float   0:disable build
#define PARAM_DOUBLE_NUM       0  // "d" double  0:disable build
#define PARAM_SCI_NUM          2  // "e" science 0:disable build
...
extern double get_param_double(char index);
#endif
#if ( PARAM_SCI_NUM >= 1 )
extern float get_param_sci(char index);
#endif
 ...
 *     }
 */
extern char dbg_cmd_exec(char *cmd, char param_table[], char help_msg[]);
